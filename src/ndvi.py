...
def analyze_vegetation(ms_image_path):
    ...
    equalized = clahe.apply(ndvi_uint8)
    ...
    health_map[ndvi < 0.20] = 0
    health_map[(ndvi >= 0.20) & (ndvi < 0.45)] = 1
    health_map[(ndvi >= 0.45) & (ndvi < 0.65)] = 2
    health_map[ndvi >= 0.65] = 3
